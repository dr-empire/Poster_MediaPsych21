...
main_width: 0.5
main_findings:
  - '![](/Users/Rosa/Dropbox/Work in Progress/Sexism_online/sexism_1/poster_mediapsych21_files/badges.png){.main_pic}'
...
logoleft_name: '![](/Users/Rosa/Dropbox/Work in Progress/Sexism_online/sexism_1/poster_mediapsych21_files/QR.png){.main-img-left}'
...
d = read_sav("/Users/Rosa/Dropbox/Work in Progress/Sexism_online/sexism_1/D-P20-11644 - Stufe 2.sav")
d = d %>% 
...
m_h1b %>% 
  plot_model(type = "int", title = "", axis.title = c("Participant gender", "Likelihood of expression"), legend.title = "", line.size = 0.25, dot.size = 1) + theme(text = element_text(size = 6))
#Both predictors were effect-coded before the analysis.
...
m_h2 %>% 
  plot_model(type = "int", title = "", axis.title = c("Participant gender", "Expected sanctions"), show.legend = TRUE, line.size = 0.50, dot.size = 1) + theme(text = element_text(size = 6), legend.spacing.y = unit(0, "mm"), legend.text = element_text(size = 4)) 
```
...
#r_refs(file = "/Users/Rosa/Dropbox/Work in Progress/Sexism_online/sexism_1/poster_mediapsych21_files/ref.bib")
```
